#!/bin/bash
#
# $Id: wgclient.sh 1 2016-07-10 18:56:46+04:00 toor $
#
...
udfMain() {
    ...
    local a dev fn fnKey fnTmp fnRemotePub fnLocalPub fnLocalKey host ini ipLocal iSerial local path pathPri pathPub port encrypt s
    ...
    udfIni $ini ':dev;host;port;keepalive ssl:encrypt;decrypt'
